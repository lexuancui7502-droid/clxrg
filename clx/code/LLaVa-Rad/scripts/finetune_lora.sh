...
PROJECTOR="/media/cuilexuan/clx/weights/llava-rad/non_lora_trainables.bin" # generated using pretrain.sh
################## 视觉编码器配置 ##################
...
# data_path=/media/cuilexuan/clx/data/multiview-cxr-annotations-1.0.0/train_sample_20.json
...
# 核心训练命令 - LoRA 配置
# 新增了一行，让 projector 继续微调 --tune_mm_mlp_adapter True \   
