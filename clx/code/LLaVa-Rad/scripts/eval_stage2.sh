...
TRAIN_MODEL_PATH="${TRAIN_MODEL_PATH:-/media/cuilexuan/clx/results/mv_stage2/biomedclip_cxr_518-stage2A_lockAnchor-0.2e-base2e-5-mm3e-6-ar3e-5-20260105225422}"
